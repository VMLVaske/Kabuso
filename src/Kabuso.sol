    ...
    require(
      verifier.verifyProof(
        ...
        [
          ...
          uint160(address(_recipient)), // Convert address payable to address, then to uint160
          uint160(address(_relayer)), // Convert address payable to address, then to uint160
          _fee,
          _refund
        ]
      ),
